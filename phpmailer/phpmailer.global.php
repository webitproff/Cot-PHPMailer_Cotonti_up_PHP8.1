...
function cot_mail_custom($fmail, $subject, $body, $headers, $customtemplate, $additional_parameters, $html)
{
	...
	else
	{
		...
		require_once Cot::$cfg['plugins_dir'].'/phpmailer/src/Exception.php';
		require_once Cot::$cfg['plugins_dir'].'/phpmailer/src/PHPMailer.php';
		require_once Cot::$cfg['plugins_dir'].'/phpmailer/src/SMTP.php';
